...
public class RTPThreadHandler extends Thread {
    ...
    RTPThreadHandler(InetAddress MulticastAddress, int SendFromLocalPort, int MulticastPort, Session session) {
        ...
        session.outprintln("Opening local port " + m_sendPort + " for sending RTP..");
        try {
