...
public class RTCPReceiverThread extends Thread {
    ...
    RTCPReceiverThread(InetAddress MulticastGroupIPAddress, int RTCPGroupPort, Session session) {
    ...
    public void StartRTCPReceiver() {
        ...
        System.out.println("RTCP Receiver Thread started ");
        System.out.println("RTCP Group: " + m_InetAddress + ":" + m_port);
        ...
        try {
            ...
            while (flag) {
                ...
                System.out.println(new Long((new Date()).getTime()).toString() + "   " + "RTCP" + "  ");

                socket.receive(Header);
                System.out.println("Len " + Header.getLength() + "  " + "from " + Header.getAddress() + ":" + Header.getPort() + "\n");
                ...
                if ((PayloadType_1 != RTCPConstants.RTCP_SR) &
                    ...
                    System.out.println("RTCP Header Check Fail : First Payload type not a SR or RR\n");


                //RTCP Header Validity Check 3

                if ((((packet[0] & 0xff) >> 5) & 0x01) != 0)
                    System.out.println("RTCP Header Check Fail : First Padding bit not zero\n");
                ...
                while (TotalBytesRead < Header.getLength()) {
                    ...
                    if (version != 0x02)
                        System.out.println("RTCP Header Check Fail : Wrong Version\n");
                    ...
                    if (pt == RTCPConstants.RTCP_SR) {
                        ...
                        System.out.println("(SR ssrc=0x" + Long.toHexString(ssrc) + "    count= " + RC
                                + "   len =  " + length + "\n");
                        ...
                        if (length != 1) // Not an empty packet
                        {
                            ...
                            System.out.println("ntp = " + ntp_sec + " " + ntp_frac + "   ts=   " +
                        ...
                        for (int j = 0; j < RC; j++) {
                            ...
                            System.out.println("(ssrc=0x" + Long.toHexString(Rcvr_ssrc) + "    fraction =  " + FractionLost
                    ...
                    if (pt == RTCPConstants.RTCP_RR) {
                        ...
                        System.out.println("( RR ssrc=0x" + Long.toHexString(ssrc) + "    count= " + RC
                                + "   len =  " + length + "\n" + ")" + "\n");
                    ...
                    if (pt == RTCPConstants.RTCP_SDES) {
                        ...
                        for (int j = 0; j < SC; j++) //Parse the packet for all sources
                        {
                            ...
                            System.out.println("(SDES ssrc=0x" + Long.toHexString(ssrc) + "    count= " + SC
                            ...
                            while ((((byte) (packet[BytesRead] & 0xff)) != 0x00) && (len > 0)) {
                                ...
                                System.out.println(ItemType + "=" + "\"" + text + "\"  ");
                    ...
                    if (pt == RTCPConstants.RTCP_BYE) {
                        ...
                        byte SC = (byte) ((packet[BytesRead] & 0xff) & 0x1f);
                        BytesRead += 4;
                        System.out.println("(BYE" + "    count= " + SC
                                + "   len =  " + length + "\n" + ")" + "\n");
                        ...
                        for (i = 0; i < SC; i++) {
                            ...
                            //Increment the Bytes read by the length of this packet
                            BytesRead += 4;
                            System.out.println("ssrc=0x" + Long.toHexString(ssrc));

                            System.out.println("In the Bye Packet " + i);
                        ...
                        System.out.println("len = " + Fieldlength);

                        System.out.println("Reasons for leaving=" + "\"" + text + "\"  ");
                ...
                System.out.println("TotalBytesRead: " + TotalBytesRead + " Header.getLength" + Header.getLength());


                if (TotalBytesRead != Header.getLength())
                    System.out.println("RTCP Header Check Fail : Bytes Read do not Match Total Packet Length\n");
